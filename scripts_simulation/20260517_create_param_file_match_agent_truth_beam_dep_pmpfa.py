...
# beam_radius_all = [1]
# canvas_radius_all = [5]
# # pm_agent_all = [0.001, 0.002, 0.01, 0.02, 0.05]  # set1 - infotaxis 20260517
# # pm_agent_all = [0.003, 0.004, 0.005]  # set2 - infotaxis 20260517
# pm_agent_all = [0.001, 0.002, 0.003, 0.004, 0.005, 0.01]  # MAP 20260518
...
param_fname = (
    ...
    + "_equal_pm_pfa_match_agent_truth_beam_dep_pmpfa.csv"
)
