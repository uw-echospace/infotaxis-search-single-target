...
pmax_th = 0.95
pmax_diff_th = 1e-5
simulation_type = "beam_move_res"  # "simple", "beam_move_res", "mismatch", or "beam_dep"


# Path to save output csv
path_main = Path("/Volumes/ssd_2tb_1/infotaxis_simu_2026")
path_summary_ph = path_main / "20251118_summary"
path_csv = path_main / "20260608_infotaxis_beam_movement_restriction_summary_compiled_pmax095_pmaxDiff1e-5"
...
for cr in cr_all:
    for br in br_all:
        for bmr in bmr_all:
            for pm in pm_all:
                print("------------------------------------------------")
                print(f"cr={cr}, br={br}, bmr={bmr}, pm=pfa={pm}")
