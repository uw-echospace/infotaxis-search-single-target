...
pmax_th = 0.99
pmax_diff_th = 1e-5
simulation_type = "simple"  # "simple", "mismatch", or "beam_dep"


# Path to save output csv
path_main = Path("/Volumes/ssd_2tb_1/infotaxis_simu_2026")
path_summary_ph = path_main / "20251027_summary"
path_csv = path_main / "20260530_infotaxis_match_summary_compiled_pmax099_pmaxDiff1e-5"
...
cr_all = [5, 10]
br_all = [1, 2]
pm_all = [0.001, 0.005, 0.01, 0.02, 0.05]
